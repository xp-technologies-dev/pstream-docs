---
title: Deploy
description: Deploy the P-Stream backend server.
---
...
For configuration, check out the [configuration reference](/pstream-docs/backend/configuration).

## Method 1 - Docker Deployment

This method provides a straightforward setup with minimal configuration. For more extensive customization, see the [Configuration Reference](/pstream-docs/backend/configuration).
...
2. Click the [`Deploy on Railway`](https://railway.com/deploy/pstreambackend?referralCode=zvXFZF) button above.
...
7. Congratulations! You have deployed the backend, you can now [set up the
   client](/pstream-docs/self-hosting/use-backend).
</Steps>
