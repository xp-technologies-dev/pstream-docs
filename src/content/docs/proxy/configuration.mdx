---
title: Configuration
description: Configuration reference for the P-Stream proxy.
---
...
:::caution
Keep in mind that you will also need to [configure the Turnstile key on the
client](/pstream-docs/client/configuration#vite-turnstile-key) and **configure the
