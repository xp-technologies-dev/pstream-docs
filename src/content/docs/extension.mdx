...
description: The P-Stream browser extension enhances streaming quality and makes it possible to scrape more sources.
---
...
<Steps>
1. Download and **unpack** the ZIP file from [here](https://github.com/p-stream/extension/releases).
...
2. **Patch omni.ja**
   ...
   Download [omniPatcher.py](https://github.com/okikio/blob/main/public/omniPatcher.py) and run it as follows:
   ```
