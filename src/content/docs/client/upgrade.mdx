---
title: Update guide
description: Keep your P-Stream client instance up to date.
---
...
<Steps>
1. If you have not already, click [here](https://github.com/p-stream/p-stream/fork) to fork the P-Stream Github repository.
