---
title: Selfhost
description: Complete guide to self-deploying P-Stream with Docker Compose.
---
...
2. **Create a Docker Compose file:**
   ...
   * Replace `TMDBReadAPIKey` with your api key, learn more [here](/pstream-docs/client/tmdb).
   * Replace `YourDomainHere` with whatever you'll be using to access your main site, like `pstream.net`.
